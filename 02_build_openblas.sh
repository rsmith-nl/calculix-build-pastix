...
# Last modified: 2024-04-23T21:13:19+0200
...
env PREFIX=/zstorage/home/rsmith/tmp/src/calculix-build NO_SHARED=1 INTERFACE64=1 BINARY=64 USE_THREAD=0 gmake install
cd ..
rm -rf OpenBLAS
